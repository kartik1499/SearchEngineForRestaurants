...
public class IndexBuilding {
	...
	public static ArrayList<String> fetchData(String query, Map<String, DictionaryEntryTerm> uncompressedIndex)  {
		try{
		//String folderPath = "yelp/biz";
		//String query = "indian restaurants";
		//String stopWordsFilePath = "yelp/stopwords.txt";
		...
		/*for (int i = 0; i < queryList.size(); i++) {
			...
			QueryReader.processQuery(queryList.get(i), uncompressedIndexv1,	doclenMaxFreqDetailsLemmas, stopWordsList, avgDocLength);
		}*/
	...
	public static Map<String, DictionaryEntryTerm> buildIndex(String folderPath,String stopWordsFilePath,String path){
		IndexBuilding indexBuilding = new IndexBuilding();
